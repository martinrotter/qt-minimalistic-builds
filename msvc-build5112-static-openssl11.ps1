...
# 1.1.0f
$openssl_base_folder = "C:\openssl11"
...
cp "$openssl_libs_folder\*MT*.lib" "$prefix_folder\lib\"
...
& "$tools_folder\7za.exe" a -t7z "${prefix_base_folder}-openssl11.7z" "$prefix_folder" -mmt -mx9